...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:        
        ...
        # If no information about parents calculate unconditional probabilities
        ...
        # If there is information about parents calculate conditional probabilities
        else:
            
            # Parents' probablities of passing genes
            ...
            # Child's probablities of getting genes
            if person in two_genes:
                ...
                joint_prob *= (1 - parents[father]) * (1 - parents[mother])
        
        # "Trait" probabilities. Joint probabilities (gene * trait)
...
def normalize(probabilities):
    ...
    for person in probabilities:
        ...
        a = 1 / (probabilities[person]["gene"][1] + probabilities[person]["gene"][2] + probabilities[person]["gene"][0])
        probabilities[person]["gene"][1] *= a
        probabilities[person]["gene"][2] *= a
        probabilities[person]["gene"][0] *= a

        # Normalize "trait" distribution
        b = 1 / (probabilities[person]["trait"][True] + probabilities[person]["trait"][False])
